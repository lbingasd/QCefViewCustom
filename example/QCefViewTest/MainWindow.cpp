...
MainWindow::createRightCefView()
{
  ...
  //
  m_pRightCefViewWidget = new CefViewWidget("https://live.kuaishou.com/u/3xrfenwwbywgmag", &setting, this);
  connect(m_pRightCefViewWidget, &QCefView::beforeResourceLoad, this, &MainWindow::onBeforeResourceLoad);
...
void
MainWindow::onBeforeResourceLoad(int browserId,
    qint64 frameId,
    const QString& url,
    const QString& headers)
{
  qDebug() << "onBeforeResourceLoad"<< url;
}
